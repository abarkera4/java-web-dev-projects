...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        String q3 = "Which poem did history-making poet Amanda Gorman recite at the U.S. prsidential inaguration in 2021?";
        ...
        //Interact with User (run quiz, score)
        quiz.run();

        String newLine = System.lineSeparator();
        System.out.println(newLine + "You answered " + quiz.getNumCorrect() + " of " + quiz.getQuestions().size() + " questions correctly. Good Job!" + newLine);
